...
public class ReflectionsTest {
    ...
    public void invokeMethod() {
        TestBean bean = new TestBean();
        // 使用函数名+参数类型的匹配
        assertThat(Reflections.invokeMethod(bean, "privateMethod", new Class[] { String.class },
                new Object[] { "calvin" })).isEqualTo("hello calvin");

        // 仅匹配函数名
        assertThat(Reflections.invokeMethodByName(bean, "privateMethod", new Object[] { "calvin" }))
