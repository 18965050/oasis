...
public class Dialect {
    ...
    public static final String PLACEHOLDER_OFFSET = "__offset";
    public static final String PLACEHOLDER_LIMIT = "__limit";
    ...
    public Object[] getParameters(int offset, int limit) {
        if (offset != SqlExecutor.NO_SKIPPED_RESULTS) {
    ...
    public String[] getPlaceholderNames(int offset, int limit) {
        if (offset != SqlExecutor.NO_SKIPPED_RESULTS) {
            return new String[] { PLACEHOLDER_OFFSET, PLACEHOLDER_LIMIT };
        } else {
