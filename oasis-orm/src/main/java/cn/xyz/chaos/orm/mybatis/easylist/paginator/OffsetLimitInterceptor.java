...
import cn.xyz.chaos.orm.mybatis.easylist.paginator.dialect.Dialect;
...
import cn.xyz.chaos.orm.mybatis.easylist.paginator.support.PropertiesHelper;
import cn.xyz.chaos.orm.mybatis.easylist.paginator.support.SQLHelp;
            ...
            Callable<Paginator> countTask = new Callable() {
                ...
                public Object call() throws Exception {
                    ...
                    if (cache != null && countMs.isUseCache()) {
                        CacheKey cacheKey = executor.createCacheKey(countMs, countParam, new PageBounds(),
