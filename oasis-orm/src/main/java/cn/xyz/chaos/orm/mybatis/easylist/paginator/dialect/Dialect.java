...
import cn.xyz.chaos.orm.mybatis.easylist.paginator.domain.Order;
            ...
            if (criteria.isValid()) {
                ...
                for (Criterion criterion : criteria.getCriteria()) {
                    ...
                    if (criterion.isBetweenValue()) {
                        ...
                        setWhereParameter(whereParamName, criterion.getValue(), criterion.getValue().getClass());
                        setWhereParameter(secondWhereParamName, criterion.getSecondValue(),
                                criterion.getSecondValue().getClass());
                    }
