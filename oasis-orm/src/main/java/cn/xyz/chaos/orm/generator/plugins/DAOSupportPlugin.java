package cn.xyz.chaos.orm.generator.plugins;
...
public class DAOSupportPlugin extends PluginAdapter {
    ...
    public void setProperties(Properties properties) {
        ...
        daoAnnotation = new FullyQualifiedJavaType(
                properties.getProperty(DAO_ANNOTATION_PROPERTY_NAME, "cn.xyz.chaos.orm.mybatis.MyBatisRepository"));
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
        ...
        if (introspectedTable.getTargetRuntime() == TargetRuntime.MYBATIS3) {
            daoNameBuilder.append(
                    introspectedTable.getMyBatis3JavaMapperType().replaceAll(MYBATIS_MAPPER_SUFFIX_REGEX, daoSuffix));
        ...
        // 生成DAO文件但不替换原有的DAO
        GeneratedJavaFile daoJavaFile = new GeneratedJavaFile(daoClass,
    ...
    public boolean sqlMapGenerated(GeneratedXmlFile sqlMap, IntrospectedTable introspectedTable) {
        ...
        GeneratedXmlFile xmlFile = new GeneratedXmlFile(daoDocument,
                nameSpace.substring(nameSpace.lastIndexOf(".") + 1) + ".xml",
