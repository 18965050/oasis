package cn.xyz.chaos.orm.mybatis.easylist.list;

import java.util.List;

import cn.xyz.chaos.orm.mybatis.easylist.list.base.ISortItem;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SearchCriteriaAssembler;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SearchCriteriaSupport;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SearchData;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SearchDataAssembler;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SortCriteriaAssembler;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SortCriteriaSupport;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.SortDataAssembler;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.modifier.SearchCriteriaModifier;
import cn.xyz.chaos.orm.mybatis.easylist.list.criteria.modifier.SortCriteriaModifier;
...
public final class EasyListHelper {
     ...
     * 根据vo，获得一个已装配查询条件和排序条件的PageBounds。 <br/>
     * 该PageBounds使用
     * {@link #cn.xyz.chaos.mybatis.easylist.paginator.domain.PageBounds.PageBounds(int limit, int page, boolean containsTotalCount)}
     * 初始化。<br/>
