...
public class ConfigUtils {
    ...
    public static final String CONTEXT_PROPERTIES_FILE = "context.properties.file";
    public static final String DEFAULT_CONTEXT_PROPERTIES = "context.properties";
    ...
    public static boolean isEmpty(String value) {
        return (value == null) || (value.length() == 0) || "false".equalsIgnoreCase(value)
                || "0".equalsIgnoreCase(value) || "null".equalsIgnoreCase(value) || "N/A".equalsIgnoreCase(value);
    }
    ...
    public static Properties getProperties() {
        if (PROPERTIES == null) {
            synchronized (ConfigUtils.class) {
                if (PROPERTIES == null) {
                    String path = System.getProperty(CONTEXT_PROPERTIES_FILE);
                    if ((path == null) || (path.length() == 0)) {
                        path = System.getenv(CONTEXT_PROPERTIES_FILE);
                        if ((path == null) || (path.length() == 0)) {
                            path = DEFAULT_CONTEXT_PROPERTIES;
                        }
                    }
    ...
    public static Properties loadProperties(String fileName, boolean allowMultiFile, boolean optional) {
        ...
        try {
            Enumeration<java.net.URL> urls = ClassUtils.getDefaultClassLoader().getResources(fileName);
        ...
        if (!allowMultiFile) {
            ...
            try {
                properties.load(ClassUtils.getDefaultClassLoader().getResourceAsStream(fileName));
            } catch (Throwable e) {
                logger.warn("Failed to load " + fileName + " file from " + fileName + "(ingore this file): "
                        + e.getMessage(), e);
            }
