 ...
 * </pre>
 *
 * @see https://github.com/nareoivy/lumaQQ/blob/master/src/edu/tsinghua/lumaqq/IPSeeker.java
 * @author luma
 */
public class IPSeeker {
    ...
    private static final String bad_ip_file = "数据库损坏";
    ...
    private IPSeeker() {
        ...
        b3 = new byte[3];
        try {
            ipFile = new RandomAccessFile(IPDataUtil.getIPDataPath(), "r");
