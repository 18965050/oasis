package cn.xyz.chaos.guava.common.model;
...
public class Person implements Comparable<Person> {
    ...
    public int compareTo(Person o) {
        return ComparisonChain.start().compare(this.firstName, o.getFirstName()).compare(this.lastName, o.getLastName())
                .compare(this.age, o.getAge()).compare(this.sex, o.getSex()).result();
    }
