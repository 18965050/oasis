...
public class TradeAccountEvent {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof TradeAccountEvent))
            return false;
        ...
        if (Double.compare(that.amount, amount) != 0)
            return false;
        if (tradeAccount != null ? !tradeAccount.equals(that.tradeAccount) : that.tradeAccount != null)
            return false;
        if (tradeExecutionTime != null ? !tradeExecutionTime.equals(that.tradeExecutionTime)
                : that.tradeExecutionTime != null)
            return false;
    ...
    public String toString() {
        return "TradeAccountEvent{" + "amount=" + amount + ", tradeExecutionTime=" + tradeExecutionTime + ", tradeType="
                + tradeType + ", tradeAccount=" + tradeAccount + "} ";
    }
