...
/**
 * {@link com.google.common.collect.FluentIterable}单元测试
 * <p/>
 * FluentIterable 提供了一种fluent style访问集合的方式
 *
 * @author lvchenggang
 *
 */
public class FluentIterablesTest {
    ...
    /**
     * {@link com.google.common.collect.FluentIterable#filter(Predicate)}测试
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * {@link com.google.common.collect.FluentIterable#anyMatch(Predicate)}测试
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * {@link com.google.common.collect.FluentIterable#allMatch(Predicate)}测试
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * {@link com.google.common.collect.FluentIterable#filter(Predicate)}无匹配结果测试
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * {@link com.google.common.collect.FluentIterable#transform(Function)}测试
     *
     * @throws Exception
     */
    @Test
