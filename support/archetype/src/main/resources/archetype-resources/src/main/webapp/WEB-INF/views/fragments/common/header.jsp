...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${symbol_dollar}{ctx }/">New Project</a>
    </div>
    <div class="collapse navbar-collapse pull-right">
      <ul class="nav navbar-nav">
        <shiro:authenticated>
          ...
          <li><a href="${symbol_dollar}{ctx }/logout">退出</a></li>
        </shiro:authenticated>
        <shiro:notAuthenticated>
          <li><a href="${symbol_dollar}{ctx }/auth/auth/login">登陆</a></li>
          <li><a href="${symbol_dollar}{ctx }/auth/auth/register">注册</a></li>
        </shiro:notAuthenticated>
