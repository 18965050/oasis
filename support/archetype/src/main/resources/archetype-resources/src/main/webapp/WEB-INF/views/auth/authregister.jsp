...
<chaos:override name="javascript">
  <script src="${symbol_dollar}{ctx}/assets/third-party/jquery-validation-1.13.0/jquery.validate.min.js" type="text/javascript" ></script>
  <script>
...
<chaos:override name="content">
  <form id="form" class="form-horizontal form-signin" role="form" action="${symbol_dollar}{ctx}/auth/auth/registerpost" method="post">
    <h2 class="form-signin-heading">请注册</h2>
    <c:if test="${symbol_dollar}{'fail' eq result}">
      <div class="alert alert-error controls input-large">
        <button class="close" data-dismiss="alert">×</button>
        <c:out value="${symbol_dollar}{msg }" />
