...
<chaos:override name="content">
  <form class="form-signin" role="form" action="${symbol_dollar}{ctx}/auth/auth/login" method="post">
    <h2 class="form-signin-heading">请登录</h2>
    <c:if test="${symbol_dollar}{not empty loginErrorMsg}">
      <div class="alert alert-error controls input-large">
        <button class="close" data-dismiss="alert">×</button>
        <c:out value="${symbol_dollar}{loginErrorMsg }" />
      </div>
    </c:if>
