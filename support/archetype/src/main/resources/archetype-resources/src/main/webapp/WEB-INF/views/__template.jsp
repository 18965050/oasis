...
<head>
  ...
  <!-- 公用CSS -->
  <link href="${symbol_dollar}{ctx}/assets/third-party/bootstrap/css/bootstrap.min.css" type="text/css" rel="stylesheet"/>
  <link href="${symbol_dollar}{ctx}/assets/css/common/common.css" type="text/css" rel="stylesheet"/>
  <!-- css -->
...
<div id="mainContent" class="container">
  <div class="row">
    <div id="rightContent" class="col-md-12">
      ...
      <input id="reqURI" type="hidden" value="${symbol_dollar}{reqURI}">
    </div>
  </div>
</div>
<!-- 尾部 -->
...
<script src="${symbol_dollar}{ctx}/assets/third-party/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${symbol_dollar}{ctx}/assets/js/template.js" type="text/javascript"></script>
<!-- javascript -->
