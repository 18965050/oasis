package cn.xyz.chaos.examples.quickstart;
 ...
 * @author calvin
 */
public class QuickStartServerForNotEclipse {
    ...
    public static String getAbsolutePath() {
        String path = null;
        String folderPath = QuickStartServerForNotEclipse.class.getProtectionDomain().getCodeSource().getLocation()
                .getPath().substring(1);
